...
<p>🍓USERID</p>
<input type ="text" name = "id" required="required" pattern="^([0-9a-zA-Z]{5,20})$" placeholder="半角英数字5～20文字">

<p>🍓PASSWORD</p>
<input type ="password" name = "password" required="required" pattern="^([0-9a-zA-Z]{8,32})$" placeholder="半角英数字8～32文字">
