...
<form action="../jp.co.aforce.servlets/product-search2" method="post">
...
<form action="../jp.co.aforce.servlets/product-update" method="post">
...
<p>商品詳細：<textarea name = "information" cols="60" rows="6"  required="required" placeholder = "${product.information}"></textarea></p>
